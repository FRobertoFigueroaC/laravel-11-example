  ...
  <form method="POST" action="/jobs/{{$job->id}}">
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base font-semibold leading-7 text-gray-900">Edit this position</h2>
            ...
            <div class="mt-2">
              <div
                ...
                <input type="text" name="title" id="title" autocomplete="title" value="{{$job->title}}"
                  ...
                  placeholder="Shiftt Leader" required>
              </div>
              @error('title')
    ...
    <div class="mt-6 flex items-center justify-between gap-x-6">
      ...
      <div class="flex items-center gap-x-6">
        <a href="/jobs/{{$job->id}}" type="button" class="rounded-md border-1 px-3 py-2 text-sm font-semibold leading-6 text-gray-900">
          Cancel
        </a>
        <button type="submit"
